...
export default async function MapoModule(moduleOptions) {
    ...
    this.options = _mergeWith(this.options, mapoDefaults, userNuxtConfig.default || {}, customMerger)
    ...
    // INJECT i18n MODULE
    this.requireModule(['nuxt-i18n', (this.options && this.options.i18n) || userModuleOptions.i18n || mapoDefaults.i18n || {}])
