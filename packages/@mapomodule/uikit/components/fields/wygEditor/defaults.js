...
export default {
    ...
    menu: { insert: { title: 'Insert', items: 'link mapomedia media template codesample inserttable | charmap emoticons hr | pagebreak nonbreaking anchor toc | insertdatetime' } },
    ...
    contextmenu: 'link mapomedia imagetools table',
