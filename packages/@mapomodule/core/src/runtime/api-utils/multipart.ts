import { deepClone, getPointed, setPointed, filesInObject } from '@mapomodule/utils/helpers/objHelpers'
...
*/
function transformRequestInMultipart(payload: Object, file_attributes = "auto") {
    ...
    const files: { [key: string]: File } = file_paths.reduce((acc, path) => {
...
export { transformRequestInMultipart }
