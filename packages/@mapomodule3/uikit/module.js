...
export default async function (moduleOptions) {
    ...
    this.requireModule(['@nuxtjs/vuetify', moduleOptions.vuetify || {}]);

    // INJECT I18N MODULE
    this.requireModule(['@nuxtjs/i18n', moduleOptions.i18n || {},]);
    ...
    const { routeNameSplitter, trailingSlash } = moduleOptions.router
    const disabled = moduleOptions['disabledRoutes'] && (Array.isArray(moduleOptions['disabledRoutes']) ? moduleOptions['disabledRoutes'] : moduleOptions['disabledRoutes'].split(" ")) || []
